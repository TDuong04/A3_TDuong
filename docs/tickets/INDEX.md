...
**7 open** · **21 done** · **40 of 40 rubric points** tracked (each row counted once, even where two tickets share it)
...
| [A3-035](A3-035-fix-arena-evaluation-run-to-run-non-determinism.md) | P1 | bug | Fix arena evaluation not being reproducible run to run from a fixed seed | I | 4 | eval | unassigned | — |
...
| [A3-034](A3-034-add-potential-based-reward-shaping-for-rotation.md) | P2 | feature | Add potential-based reward shaping to fix rotation-style arena aim and survival | Creativity | — | arena | unassigned | — |
